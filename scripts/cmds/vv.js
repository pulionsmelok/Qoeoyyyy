...
module.exports = {
  config: {
    ...
    longDescription:
      "Reply to a view-once (1-time view) image, video, or voice note to download and resend it permanently.",
    category: "media",
    ...
    try {
      ...
      if (
        ...
        return message.reply(
          "❌ Please reply to a View Once image, video, or audio message.",
        );
      }
      ...
      try {
        ...
        await message.react("❌");
        return message.reply(
          "❌ Failed to decrypt/download media: " + err.message,
        );
      }
      ...
      if (attachment.type === "image") {
        ...
        await api.sendVideo(buffer, event.threadID, caption, {
          mimetype: attachment.mimetype || "video/mp4",
        });
      } else if (attachment.type === "audio" || attachment.type === "ptt") {
        await api.sendAudio(buffer, event.threadID, {
