                ...
                if (content && typeof content === "object") {
                    ...
                    if (content.attachment) {
                        ...
                        if (typeof type === "string") {
                            ...
                            mediaType = content.mimetype && String(content.mimetype).toLowerCase().startsWith("image/") ? "image" : "document";
                            media = type;
                        } else if (type && typeof type === "object") {
                            if (type.path && typeof type.path === "string") mediaType = getMediaType(type.path);
                            if (!(type instanceof Buffer) && !(type instanceof Readable)) {
                                if (type.type) mediaType = type.type;
                                else if (type.mimetype && String(type.mimetype).toLowerCase().startsWith("image/")) mediaType = "image";
                                else if (type.url) mediaType = getMediaType(type.url);
                                if (type.data && Buffer.isBuffer(type.data)) media = type.data;
                                else if (type.stream) media = normalizeAttachment(type.stream);
                                else if (type.url) media = normalizeAttachment(type.url);
                            }
                        }
                        if (mediaType === "ptt") {
